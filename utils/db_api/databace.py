...
category_all = [
    ...
    "обеспыливание и чистка полов",
    "Обеспыливание ковров",
    "Обеспыливание и чистка люстр",
    "Обеспыливание  и чистка потолков",
    "Обеспыливание и чистка обои",
    "Чистка ванн",
    "чистка туалета. (Сан.узлов)",
    "Чистка оконных блогов и стёкол",
    "Чистка мебели",
    "Стирка ковров(на месте с робоклин",
    "Химчистка мебел",
    "Химчистка матрасов",
    "митьё посуд",
    "Привести  порядок в гардеробах",
    "Уборка в подвалных помещениях",
    "Поглаживание",
    "Мытья брусчаток",
    "Чистка алюкобонд",
    "Стрижка газонов (газонокосилка)",
    "Мытье и чистка фасад",
    "Дезинфекция",
    "Митьё и поглаживание штор",
]
