...
category_all = [
    ...
    "Удаление пыли со всех мест",
    "Удаление пыли со всех мест",
    "Удаление пыли с ковра",
    "Удаление пыли с обоев",
    "Удаление пыли с люстр",
    "Удаление пыли с потолка",
    "Уборка ванной",
    "Уборка туалета",
    "Мытье окон",
    "Удаление пыли с мебели",
    "Удаление пыли с пола",
    "Уборка санузла",
    "Стирка ковров на месте",
    "Химчистка дивана",
    "Химчистка матраса",
    "Мытье посуды",
    "Уборка одежды",
